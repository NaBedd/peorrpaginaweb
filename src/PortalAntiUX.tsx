...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "GlobalCorp Solutions | Portal de Empleo" },
      {
        name: "description",
        content:
          "Postúlese a las vacantes de GlobalCorp Solutions a través de nuestro moderno portal de aplicaciones en línea.",
      },
      { property: "og:title", content: "GlobalCorp Solutions | Portal de Empleo" },
      {
